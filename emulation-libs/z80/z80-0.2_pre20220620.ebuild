...
SRC_URI="https://zxe.io/software/Z80/download/Z80-0.2-pre-2022-06-20.tar.xz"
...
src_configure() {
	...
	myconfigure() {
		mycmakeargs+=(
			...
			-DZ80_WITH_RESET_SIGNAL=$(usex z80-reset_signal)
			-DZ80_WITH_SPECIAL_RESET_SIGNAL=$(usex z80-special_reset_signal)
